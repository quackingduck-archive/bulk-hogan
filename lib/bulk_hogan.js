...
(function() {
  ...
  templates.load = function(cb) {
    ...
    return async.parallel({
      ...
      _ref1 = results.moduleTemplates.compiledTemplates;
      for (k in _ref1) {
        v = _ref1[k];
        compiledTemplates[k] = v;
      }
      _ref2 = results.templates.sourceTemplates;
      for (k in _ref2) {
        v = _ref2[k];
        sourceTemplates[k] = v;
      }
      _ref3 = results.moduleTemplates.sourceTemplates;
      for (k in _ref3) {
        v = _ref3[k];
        sourceTemplates[k] = v;
      }
      if (!_this.reload) {
        _this.compiledCache = compiledTemplates;
      }
      if (!_this.reload) {
        _this.sourceCache = sourceTemplates;
      }
  ...
  readAndCompileTemplates = function(dir, globFilter, nameFromFilenameFn, cb) {
    return async.waterfall([
      ...
      var fileName, i, name, result, _i, _len;
